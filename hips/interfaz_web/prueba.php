...
<html>
	...
	<select id="tablabd" name="tabla" class="div-toggle" data-target=".my-info-1">
		...
		<option value="correo_lista_negra" data-show=".correo_lista_negra">Correo no Deseado</option>
	</select>
	
	<div class="my-info-1">
		<div id="ninguno" class="ninguno hide"> </div>
		<div id="usuarioRegistro" class="usuario_registro hide">
			<br/>
			<br/>
			<b>Agregar fila:</b>
			<br/>
		...
		<div id="alarma" class= "alarma hide">
			...
			<br/>
			<form action="actualizar.php" method="post">
				<input type="text" placeholder="'id_alarma'" name="id_alarma" required />
		...
		<div id="prevencion" class="prevencion hide">
			...
			<br/>
			<form action="actualizar.php" method="post">
				<input type="text" placeholder="'id_prevencion'" name="id_prevencion" required />
