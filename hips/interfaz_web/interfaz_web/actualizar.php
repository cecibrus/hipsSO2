<?php
	...
	}elseif(isset($_POST['addCorreoListaNegra'])){
		$fecha = $_POST['correo'];
	...
	}elseif(isset($_POST['addHashes'])){
		$nombre_archivo = $_POST['nombre_archivo'];
		$hash = $_POST['hash'];

		$query = "INSERT INTO hashes_archivos(nombre_archivo,hash) VALUES ('$nombre_archivo','$hash');";
		unset($_POST['addHashes']);
		echo "Nuevo hashes_archivos registrado";
	
	}elseif(isset($_POST['addSniffers'])){
		$nombre = $_POST['nombre'];

		$query = "INSERT INTO sniffers(nombre) VALUES ('$nombre');";
		unset($_POST['addSniffers']);
		echo "Nuevo sniffers registrado";

	}elseif(isset($_POST['delSniffers'])){
		$id_sniffer_d = $_POST['id_sniffer_d'];
		$query = "DELETE FROM sniffers WHERE id_sniffer = '$id_sniffer_d';";
		unset($_POST['delSniffers']);
		echo "Registro de sniffers eliminado correctamente.";
	
	}elseif(isset($_POST['delHash'])){
		$id_hash_d = $_POST['id_hash_d'];
		$query = "DELETE FROM hashes_archivos WHERE id_hash = '$id_hash_d';";
		unset($_POST['delHash']);
		echo "Registro de hashes_archivos eliminado correctamente.";
